...
import com.example.walkthrough_scaffold_and_navigation_final.ui.theme.Walkthrough_Scaffold_and_navigation_FinalTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            Walkthrough_Scaffold_and_navigation_FinalTheme {
